...
**Note**: This application is designed for internal use and should be deployed in a secure environment. Always use strong passwords and keep the JWT secret secure in production environments.# daily-report-go
